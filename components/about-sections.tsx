...
export function AboutSections() {
  return (
    <>
      <section id="ueber-uns" className="relative bg-[#14181f] py-16 md:py-20">
        <div className="mx-auto max-w-6xl px-6">
          ...
          <div className="grid gap-5 md:grid-cols-2 md:justify-items-center">
            <article className="w-full max-w-sm rounded-2xl border border-white/20 bg-white/[0.04] p-4 text-center shadow-sm">
              <div className="relative aspect-[3/4] overflow-hidden rounded-xl border border-white/20 bg-white/[0.03]">
                <Image
                  src="/Viola.jpeg"
                  alt="Viola Buchhold"
                  fill
              ...
              <h3 className="mt-4 text-lg font-semibold text-zinc-100">Viola Buchhold</h3>
            ...
            <article className="w-full max-w-sm rounded-2xl border border-white/20 bg-white/[0.04] p-4 text-center shadow-sm">
              ...
              <h3 className="mt-4 text-lg font-semibold text-zinc-100">Sophie Buchhold</h3>
              <p className="mt-2 text-sm leading-relaxed text-zinc-300">
      ...
      <section id="standorte" className="relative bg-background py-12 md:py-14">
